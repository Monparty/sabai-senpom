...
export default function TitleBtn({text}) {
    ...
    return (
        <section className="flex justify-between items-center p-10">
            ...
            <Link data-aos="fade-up" data-aos-delay="500" href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 text-sm text-gray-700 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-blue-200 dark:hover:bg-gray-700" role="alert">
