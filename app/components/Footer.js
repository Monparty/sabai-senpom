    ...
    return (
        <footer className="bg-blue-100 dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:p-10">
                ...
                <div className="mb-6 md:mb-0">
                    <Link data-aos="fade-up" href="/" className="flex items-center">
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sabai Senpom</span>
                    </Link>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="/" className="hover:underline">Sabai Senpom</Link>. All Rights Reserved.
                </span>
