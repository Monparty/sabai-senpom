    ...
    return (
        <section className="bg-white dark:bg-gray-900 w-full mt-16">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:p-24">
                ...
                <p  data-aos="zoom-in" className="mb-10 text-lg font-light text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">เพื่อสุขภาพผมที่แข็งแรง สวย เงางาม ที่สำคัญไม่ขาดหลุดร่วงง่ายแล้ว สาวๆ การหลีกเลี่ยงสารเคมีที่เป็นตัวการทำร้ายเส้นผม</p>
