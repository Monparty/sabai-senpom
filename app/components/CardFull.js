...
export default function CardFull({img, title1, title2, detail, textBtn}) {
    ...
    return (
        <section className="p-10 bg-blue-50">
            <div data-aos="fade-up" className="grid md:flex rounded-md border bg-white">
                <Image src={img} className="w-full rounded-t-md md:w-auto md:h-auto object-cover md:rounded-l-md" />
                <div className="p-10">
                    <h2 data-aos="fade-up" data-aos-delay="50" className="text-2xl">{title1} <span className="text-blue-600">{title2}</span></h2>
                    <p data-aos="fade-up" data-aos-delay="100" className="py-10">{detail}</p>
